...
public class OrderController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "status", value = "订单状态：1未付款，2已付款未发货，3已发货未确认，" +
                    "4已确认未评价，5交易关闭，6交易成功，已评价", type = "Integer"),
    })
    ...
    public ResponseEntity<Boolean> updateStatus(@PathVariable("id") Long id, @PathVariable("status")
            Integer status) {
